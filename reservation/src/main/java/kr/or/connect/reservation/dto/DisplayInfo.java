...
public class DisplayInfo {
	...
	public String toString() {
		...
		return "DisplayInfo [id=" + id + ", product_id=" + product_id + ", opening_hours=" + opening_hours +", place_name=" + place_name + ", place_lot=" + place_lot +", place_street=" + place_street +", tel=" + tel +", homepage=" + homepage +", email=" + email +", create_date=" + create_date +", modify_date=" + modify_date + "]";
	}
