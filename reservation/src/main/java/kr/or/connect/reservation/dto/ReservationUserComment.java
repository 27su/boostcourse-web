...
public class ReservationUserComment {
	...
	public String toString() {
		...
		return "ReservationUserComment [id=" + id + ", product_id=" + product_id + ", reservation_info_id=" + reservation_info_id +", user_id=" + user_id +", score=" + score +", comment=" + comment +", create_date=" + create_date +", modify_date=" + modify_date + "]";
	}
